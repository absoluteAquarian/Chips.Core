namespace Chips.Core.Specifications{
	public static unsafe class Opcodes{
		...
		public static readonly Opcode Iny              = new(0x82, &Opcode.Functions.Iny,     "iny"                          , 0, true,
			OpcodeClassification.ArithmeticNoAccumulator | OpcodeClassification.NoOperand);
		public static readonly Opcode Iob_obj          = new(0x40, &Opcode.Functions.Iob,     "iob <obj>"                    , 1, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iob_var          = new(0x41, &Opcode.Functions.Iob,     "iob <var>"                    , 1, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Ioc_obj          = new(0x42, &Opcode.Functions.Ioc,     "ioc <obj>"                    , 1, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Ioc_var          = new(0x43, &Opcode.Functions.Ioc,     "iob <var>"                    , 1, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iofp_obj_obj_obj = new(0x30, &Opcode.Functions.Iofp,    "iofp <obj>, <obj2>, <obj3>"   , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iofp_obj_obj_var = new(0x31, &Opcode.Functions.Iofp,    "iofp <obj>, <obj2>, <var>"    , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iofp_obj_var_obj = new(0x32, &Opcode.Functions.Iofp,    "iofp <obj>, <var>, <obj2>"    , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iofp_obj_var_var = new(0x33, &Opcode.Functions.Iofp,    "iofp <obj>, <var>, <var2>"    , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iofp_var_obj_obj = new(0x34, &Opcode.Functions.Iofp,    "iofp <var>, <obj>, <obj2>"    , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iofp_var_obj_var = new(0x35, &Opcode.Functions.Iofp,    "iofp <var>, <obj>, <var2>"    , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iofp_var_var_obj = new(0x36, &Opcode.Functions.Iofp,    "iofp <var>, <var2>, <obj>"    , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iofp_var_var_var = new(0x37, &Opcode.Functions.Iofp,    "iofp <var>, <var2>, <var3>"   , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Ior_obj          = new(0x00, &Opcode.Functions.Ior,     "ior <obj>, <type>"            , 2, false,
			OpcodeClassification.InputOutput | OpcodeClassification.ModifiesAccumulator);
		public static readonly Opcode Ior_var          = new(0x01, &Opcode.Functions.Ior,     "ior <var>, <type>"            , 2, false,
			OpcodeClassification.InputOutput | OpcodeClassification.ModifiesAccumulator);
		public static readonly Opcode Ios_obj_obj_obj  = new(0x20, &Opcode.Functions.Ios,     "ios <obj>, <obj2>, <obj3>"    , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Ios_obj_obj_var  = new(0x21, &Opcode.Functions.Ios,     "ios <obj>, <obj2>, <var>"     , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Ios_obj_var_obj  = new(0x22, &Opcode.Functions.Ios,     "ios <obj>, <var>, <obj2>"     , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Ios_obj_var_var  = new(0x23, &Opcode.Functions.Ios,     "ios <obj>, <var>, <var2>"     , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Ios_var_obj_obj  = new(0x24, &Opcode.Functions.Ios,     "ios <var>, <obj>, <obj2>"     , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Ios_var_obj_var  = new(0x25, &Opcode.Functions.Ios,     "ios <var>, <obj>, <var2>"     , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Ios_var_var_obj  = new(0x26, &Opcode.Functions.Ios,     "ios <var>, <var2>, <obj>"     , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Ios_var_var_var  = new(0x27, &Opcode.Functions.Ios,     "ios <var>, <var2>, <var3>"    , 3, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Ios_obj_obj      = new(0x28, &Opcode.Functions.Ios,     "ios <obj>, <obj2>"            , 2, false,
			OpcodeClassification.InputOutput | OpcodeClassification.ModifiesAccumulator);
		public static readonly Opcode Ios_var_obj      = new(0x29, &Opcode.Functions.Ios,     "ios <var>, <obj>"             , 2, false,
			OpcodeClassification.InputOutput | OpcodeClassification.ModifiesAccumulator);
		public static readonly Opcode Ios_obj_var      = new(0x2A, &Opcode.Functions.Ios,     "ios <obj>, <var>"             , 2, false,
			OpcodeClassification.InputOutput | OpcodeClassification.ModifiesAccumulator);
		public static readonly Opcode Ios_var_var      = new(0x2B, &Opcode.Functions.Ios,     "ios <var>, <var2>"            , 2, false,
			OpcodeClassification.InputOutput | OpcodeClassification.ModifiesAccumulator);
		public static readonly Opcode Iow_obj_obj      = new(0x10, &Opcode.Functions.Iow,     "iow <obj>, <obj2>"            , 2, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iow_var_obj      = new(0x11, &Opcode.Functions.Iow,     "iow <var>, <obj>"             , 2, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iow_obj_var      = new(0x12, &Opcode.Functions.Iow,     "iow <obj>, <var>"             , 2, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Iow_var_var      = new(0x13, &Opcode.Functions.Iow,     "iow <var>, <var2>"            , 2, false,
			OpcodeClassification.InputOutput);
		public static readonly Opcode Io               = new(0x65, &Opcode.Functions.Ext,     "<extended opcode>"            , 0, false,
			OpcodeClassification.ExtendedOpcode,
			Iob_obj, Iob_var,
			Ioc_obj, Ioc_var,
		...
		public static readonly Opcode Mov_arrY_var     = new(0xB6, &Opcode.Functions.Mov,     "mov [<arr>, &Y], <var>"       , 2, false,
			OpcodeClassification.ValueTransfer | OpcodeClassification.ValueAccess);
		public static readonly Opcode Mov_arrX_arrY    = new(0xB6, &Opcode.Functions.Mov,     "mov [<arr>, &X], [<arr2>, &Y]", 2, false,
			OpcodeClassification.ValueTransfer | OpcodeClassification.ValueAccess);
		public static readonly Opcode Mov_arrY_arrX    = new(0xB6, &Opcode.Functions.Mov,     "mov [<arr>, &Y], [<arr2>, &X]", 2, false,
			OpcodeClassification.ValueTransfer | OpcodeClassification.ValueAccess);
